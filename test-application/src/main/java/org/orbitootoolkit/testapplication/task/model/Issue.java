 ...
 * =========================LICENSE_END==================================
 */
package org.orbitootoolkit.testapplication.task.model;
...
public class Issue {
    ...
    public Issue(String id, IssueType type) {
        log.info("new Issue [" + id + ", " + type + ", OPENED]");
        this.id = id;
        this.type = type;
        this.state = "OPENED";
    }
    ...
    public void setState(String newState) {
        log.info("Issue [" + id + "] " + this.state + " -> " + newState);
        this.state = newState;
    }
}
